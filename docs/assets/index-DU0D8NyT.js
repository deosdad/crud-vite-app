...
\r
</div>`;class y{constructor({id:t,isActive:a,balance:r,avatar:s,firstName:n,lastName:o,gender:m="male"}){this.id=t,this.isActive=a,this.balance=r,this.avatar=s,this.firstName=n,this.lastName=o,this.gender=m}}const g=e=>{const{avatar:t,balance:a,first_name:r,gender:s,id:n,isActive:o,last_name:m}=e;return new y({avatar:t,balance:a,firstName:r,gender:s,id:n,isActive:o,lastName:m})},P=async e=>{const t=`http://localhost:3001/users/${e}`,r=await(await fetch(t)).json();return g(r)};let i,d,p={};const w=async e=>{if(i==null||i.classList.remove("hide-modal"),p={},!e)return;const t=await P(e);x(t)},v=()=>{i==null||i.classList.add("hide-modal"),d==null||d.reset()},x=e=>{d.querySelector('[name="firstName"]').value=e.firstName,d.querySelector('[name="lastName"]').value=e.lastName,d.querySelector('[name="balance"]').value=e.balance,d.querySelector('[name="isActive"]').checked=e.isActive,p=e},T=(e,t)=>{i||(i=document.createElement("div"),i.innerHTML=L,i.className="modal-container hide-modal",d=i.querySelector("form"),i.addEventListener("click",a=>{a.target.className==="modal-container"&&v()}),d.addEventListener("submit",async a=>{a.preventDefault();const r=new FormData(d),s={...p};for(const[n,o]of r){if(n==="balance"){s[n]=+o;continue}if(n==="isActive"){s[n]=o==="on";continue}s[n]=o}await t(s),v()}),e.append(i))},S=e=>{const t=document.createElement("button");t.innerText="add",t.classList.add("fab-button"),e.append(t),t.addEventListener("click",()=>{w()})},E=async()=>{const r=(await(await fetch("http://localhost:3001/users?_page=1")).json()).items+1;return String(r)},f=async(e=1)=>{const t=`http://localhost:3001/users?_page=${e}`,a=await fetch(t),{data:r,pages:s}=await a.json();return{users:r.map(g),pages:s}},c={currentPage:0,users:[]},$=async()=>{const e=c.currentPage+1,{users:t,pages:a}=await f(e);t.length!==0&&(e>a||(c.currentPage+=1,c.users=t))},b=async()=>{if(c.currentPage===1)return;const{users:e}=await f(c.currentPage-1);c.users=e,c.currentPage-=1},A=e=>{let t=!1;c.users=c.users.map(a=>a.id===e.id?(t=!0,e):a),c.users.length<10&&!t&&c.users.push(e)},M=async()=>{const{users:e}=await f(c.currentPage);if(console.log(e),e.length===0){console.log(e+"hola"),await b();return}c.users=e},U=async()=>await E(),l={loadNextPage:$,onUserChange:A,reloadPage:M,loadPreviousPage:b,getNextId:U,getUsers:()=>[...c.users],getCurrentPage:()=>c.currentPage},H=async e=>{const t=`http://localhost:3001/users/${e}`;return await(await fetch(t,{method:"DELETE"})).json(),!0};let u;const q=()=>{const e=document.createElement("table"),t=document.createElement("thead");t.innerHTML=`
        <tr>
            <th>#ID</th>
            <th>Balance</th>
            <th>FistName</th>
    ...
    `;const a=document.createElement("tbody");return e.append(t,a),e},B=e=>{const t=e.target.closest(".select-user");if(!t)return;const a=t.getAttribute("data-id");w(a)},D=async e=>{const t=e.target.closest(".delete-user");if(!t)return;const a=t.getAttribute("data-id");try{await H(a),await l.reloadPage(),document.querySelector("#current-page").innerText=l.getCurrentPage(),h()}catch{alert("No se puede eliminar")}},h=e=>{const t=l.getUsers();u||(u=q(),e.append(u)),u.addEventListener("click",B),u.addEventListener("click",D);let a="";t.forEach(r=>{a+=`
        ...
        `}),u.querySelector("tbody").innerHTML=a},j=e=>{const t=document.createElement("button");t.innerText="Next >";const a=document.createElement("button");a.innerText="< Prev";const r=document.createElement("span");r.id="current-page",r.innerText=l.getCurrentPage(),e.append(a,r,t),t.addEventListener("click",async()=>{await l.loadNextPage(),r.innerText=l.getCurrentPage(),h(e)}),a.addEventListener("click",async()=>{await l.loadPreviousPage(),r.innerText=l.getCurrentPage(),h(e)})},k=e=>{const{avatar:t,balance:a,firstName:r,gender:s,id:n,isActive:o,lastName:m}=e;return{avatar:t,balance:a,first_name:r,gender:s,id:n,isActive:o,last_name:m}},C=async e=>{const t=new y(e);if(!t.firstName||!t.lastName)throw"First & Last Name are required";const a=k(t);let r;return t.id?r=await I(a):(a.id=await l.getNextId(),r=await F(a)),g(r)},F=async e=>await(await fetch("http://localhost:3001/users",{method:"POST",body:JSON.stringify(e),headers:{"Content-Type":"application/json"}})).json(),I=async e=>{const t=`http://localhost:3001/users/${e.id}`;return await(await fetch(t,{method:"PATCH",body:JSON.stringify(e),headers:{"Content-Type":"application/json"}})).json()},O=async e=>{e.innerHTML="Loading...",await l.loadNextPage(),e.innerHTML="",h(e),j(e),S(e),T(e,async t=>{const a=await C(t);l.onUserChange(a),h()})};document.querySelector("#app").innerHTML=`
  <div>
